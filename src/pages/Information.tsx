    ...
    <Layout>
      ...
      <Content className={`${cssPrefix}__content`}>
        ...
        <div className={`${cssPrefix}__info-box`}>
          ...
          <p>
            Zum Essen haben wir ein schönes Menü ausgewählt. Bitte teilt uns bei
            eurer Rückmeldung mit, ob ihr an diesem Tag die Variante mit Fleisch
            (Rind) oder vegetarisch essen möchtet.
          </p>
        ...
        <div className={`${cssPrefix}__info-box`}>
          <h4>Anfahrt</h4>
          <p>
            Die BIRDIE-Bar liegt zentral in München nahe Maxvorstadt und ist mit
            den öffentlichen Verkehrsmitteln sowie mit dem Auto gut erreichbar.
          </p>
          <p>
            Die Locations liegt auf einem Privatgelände ohne Autoverkehr. Die
            Kinder haben die Möglichkeit auch vor dem Gebäude im Außenbereich zu
            spielen (z. B. Bobby Car oder Roller fahren).
          </p>
          <p>
            Öffentliche Parkplätze sind direkt vor dem Gelände an der Straße
            vorhanden.
          </p>
          <span className={`${cssPrefix}__directions`}>
            &rarr;{" "}
            <a
              href="https://efa.mvv-muenchen.de/index.html?itdTime=1545&itdDate=20201010&language=de&name_origin=&name_destination=Infanteriestr.%2011a%2C%2080797%20M%C3%BCnchen&itdTripDateTimeDepArr=arr#trip@dest"
              target="_blank"
      ...
      <Content className={`${cssPrefix}__content`}>
        <h3>Umgebung</h3>
        <div
          className={`${cssPrefix}__info-box ${cssPrefix}__means-of-transport`}
        >
          ...
          <p>
            Zur Fahrplanauskunft empfehlen die Nutzung der MVV-App oder der
            MVG-App.
          </p>
        </div>
